...
## Project Structure
    ...
    ├── all_set_feature_ex_37386  # Django project configurations
...
1. Clone this repo and `cd all_set_feature_ex_37386`
...
2. Clone this repo and `cd all_set_feature_ex_37386`
